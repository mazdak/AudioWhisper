...
## Project Overview
AudioWhisper is a macOS menu bar app for quick audio recording and transcription using OpenAI Whisper, Google Gemini, Local WhisperKit, or Nvidia Parakeet.
