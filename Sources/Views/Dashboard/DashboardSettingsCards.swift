        ...
        Button(role: role, action: action) {
            HStack(alignment: .center, spacing: DashboardTheme.Spacing.md) {
                VStack(alignment: .leading, spacing: DashboardTheme.Spacing.xs) {
                    Text(title)
                        .font(DashboardTheme.Fonts.sans(14, weight: .medium))
                        .foregroundStyle(role == .destructive ? Color(red: 0.75, green: 0.30, blue: 0.28) : DashboardTheme.ink)
                ...
                Image(systemName: icon)
                    ...
                    .foregroundStyle(role == .destructive ? Color(red: 0.75, green: 0.30, blue: 0.28) : DashboardTheme.inkMuted)
            }
            .padding(DashboardTheme.Spacing.md)
