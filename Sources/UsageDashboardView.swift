...
struct UsageDashboardView: View {
    @ObservedObject private var metricsStore = UsageMetricsStore.shared
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            HStack(spacing: 12) {
                Button(role: .destructive) {
                    ...
                    Label("Reset Usage Stats", systemImage: "arrow.counterclockwise")
                }
                ...
                if DataManager.shared.isHistoryEnabled {
                    Button {
                        ...
                        if isRebuilding {
                            ...
                            Label("Rebuild from History", systemImage: "clock.arrow.circlepath")
                        }
                    }
        ...
        .confirmationDialog(
            ...
            Text("This clears the aggregated usage counters. Your transcription history remains untouched.")
        }
    }
