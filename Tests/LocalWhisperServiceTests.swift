...
class LocalWhisperServiceTests: XCTestCase {
    ...
    func testWhisperModelMapping() {
        ...
        XCTAssertEqual(WhisperModel.medium.whisperKitModelName, "openai_whisper-medium")
        XCTAssertEqual(WhisperModel.large.whisperKitModelName, "openai_whisper-large-v3")
        XCTAssertEqual(WhisperModel.largeTurbo.whisperKitModelName, "openai_whisper-large-v3-turbo")
    }
    ...
    func testEstimatedSizes() {
        ...
        XCTAssertEqual(WhisperModel.medium.estimatedSize, 1536 * 1024 * 1024)
        XCTAssertEqual(WhisperModel.large.estimatedSize, 2944 * 1024 * 1024)
