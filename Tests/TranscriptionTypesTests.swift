...
class TranscriptionTypesTests: XCTestCase {
    ...
    func testWhisperModelDisplayNames() {
        ...
        XCTAssertEqual(WhisperModel.medium.displayName, "Medium (1.5GB)")
        XCTAssertEqual(WhisperModel.large.displayName, "Large v3 (2.9GB)")
    ...
    func testWhisperModelFileSizes() {
        ...
        XCTAssertEqual(WhisperModel.medium.fileSize, "1.5GB")
        XCTAssertEqual(WhisperModel.large.fileSize, "2.9GB")
    ...
    func testWhisperModelFileNames() {
        ...
        XCTAssertEqual(WhisperModel.large.fileName, "ggml-large-v3.bin")
    ...
    func testWhisperModelDownloadURLs() {
        ...
        XCTAssertEqual(WhisperModel.medium.downloadURL.absoluteString, "\(baseURL)/ggml-medium.bin")
        XCTAssertEqual(WhisperModel.large.downloadURL.absoluteString, "\(baseURL)/ggml-large-v3.bin")
    ...
    func testWhisperModelDescriptions() {
        ...
        XCTAssertEqual(WhisperModel.medium.description, "High accuracy, slower")
        XCTAssertEqual(WhisperModel.large.description, "Highest accuracy, slowest")
        XCTAssertEqual(WhisperModel.largeTurbo.description, "High accuracy, optimized speed")
    }
    ...
    func testWhisperModelRawValues() {
        ...
        XCTAssertEqual(WhisperModel.large.rawValue, "large-v3")
    ...
    func testWhisperModelFromRawValue() {
        ...
        XCTAssertEqual(WhisperModel(rawValue: "large-v3"), .large)
    ...
    func testFileSizesFollowExpectedPattern() {
        ...
        XCTAssertTrue(WhisperModel.medium.fileSize.contains("1.5"))
        XCTAssertTrue(WhisperModel.large.fileSize.contains("2.9"))
    ...
    func testModelOrderingBySize() {
        ...
        // Test that tiny and base are MB, others are GB
        ...
        XCTAssertTrue(WhisperModel.medium.fileSize.contains("GB"))
        XCTAssertTrue(WhisperModel.large.fileSize.contains("GB"))
